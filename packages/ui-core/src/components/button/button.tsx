...
const buttonVariants = cva(
  'inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md font-medium text-sm text-white disabled:text-gray-400 focus:ring-2 focus:ring-purple-400 focus:ring-offset-2  disabled:cursor-not-allowed ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none',
  {
    variants: {
      variant: {
        ...
        ghost: 'hover:bg-accent text-gray-900 hover:text-accent-foreground',
        link: 'text-gray-600 hover:text-gray-700',
        'link-primary': 'text-purple-700 hover:text-purple-800',
        primary:
          'bg-purple-600 hover:bg-purple-700 shadow-button disabled:bg-gray-100  disabled:border disabled:border-gray-200 disabled:shadow-disabled-button',
