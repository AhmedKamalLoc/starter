...
import { AlertDialogContext, useAlertDialogContext } from './action-dialog-context';
...
describe('AlertDialogContext', () => {
  ...
  it('should throw error when used outside provider', () => {
    ...
    }).toThrow('useAlertDialogContext must be used within an AlertDialogContext.Provider');
  });
